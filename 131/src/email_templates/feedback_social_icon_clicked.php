<?php 
//subject :- social icon clicked
$subject = "Review submission";

//Cancel plan email body
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="center-text" simpli="" align="center" style="font-family:Catamaran,Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                        <singleline>
                                                            <div mc:edit="" simpli="">
                                                                Good news! Someone clicked to review your business! This doesn\'t necessarily mean that they left their feedback on a public website, but it\'s likely that you\'ll receive a new positive review shortly.  
                                                            </div>
                                                        </singleline>
                                                    </td>
                                                </tr>
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" align="center">
                                                                            <tr>
                                                                                ...
                                                                                <td align="center" height="50" style="height:50px;">
                                                                                    <singleline>
                                                                                        <a href="'.$final_url.'/reviews" target="_blank" mc:edit="" style="font-family:Catamaran,Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Check Reviews</span></a>
                                                                                    </singleline>
                                                                                </td>
                                                                                <td align="center" width="35"></td>
                                                                            </tr>

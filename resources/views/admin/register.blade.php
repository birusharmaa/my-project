                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="row shadow-lg p-3 mb-5 bg-white rounded justify-content ">
                        <div class="col-md-6 d-flex justify-content-center">
                            <form class="" action="registerUser" method="post" return="false">
                                ...
                                <input id="signup-email" type="text" placeholder="Enter Name" name="name" value="{{ old('name') }}">
                                @error('name')
                                ...
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <input id="signup-password" placeholder="Enter confirm password" type="password" name="confirm_password" value="{{ old('confirm_password') }}">
                                @error('confirm_password')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <input id="signup-password" type="text" maxlength="10" placeholder="Enter Mobile" name="mobile" value="{{ old('mobile') }}" class="form-control">
                                @error('password')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <button type="submit" class="btn btn-primary" name="signup_submit">Sign me up</button>
                            </form>
                        </div>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <a href="{{url('login')}}">Log in with email and password </a>
                        </div>
                    </div>
                </div>
            </div>

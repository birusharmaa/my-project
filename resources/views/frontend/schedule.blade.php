            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="tab-content mt-5" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-DayOne" role="tabpanel" aria-labelledby="nav-DayOne-tab">
                        <div class="row border-bottom pb-5 mb-5">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/fabian-friedrich-JDUVM9_VaZE-unsplash.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
                            ...
                            <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                ...
                                <div class="d-flex align-items-center mt-4">
                                    <div class="avatar-group d-flex">
                                        <img src="{{url('public/frontend/images/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg')}}" class="img-fluid avatar-image" alt="">
                        ...
                        <div class="row border-bottom pb-5 mb-5">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/clayton-cardinalli-JMoFpdqL3XM-unsplash.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/business-woman-making-presentation-office.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
                            ...
                            <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                ...
                                <div class="d-flex align-items-center mt-4">
                                    <div class="avatar-group d-flex">
                                        <img src="{{url('public/frontend/images/avatar/senior-man-white-sweater-eyeglasses.jpg')}}" class="img-fluid avatar-image" alt="">
                    ...
                    <div class="tab-pane fade" id="nav-DayTwo" role="tabpanel" aria-labelledby="nav-DayTwo-tab">
                        <div class="row border-bottom pb-5 mb-5">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/people-smiling-while-conference-room.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
                            ...
                            <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                ...
                                <div class="d-flex align-items-center mt-4">
                                    <div class="avatar-group d-flex">
                                        <img src="{{url('public/frontend/images/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg')}}" class="img-fluid avatar-image" alt="">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/jason-goodman-bzqU01v-G54-unsplash.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
                            ...
                            <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                ...
                                <div class="d-flex align-items-center mt-4">
                                    <div class="avatar-group d-flex">
                                        <img src="{{url('public/frontend/images/avatar/indoor-shot-beautiful-happy-african-american-woman-smiling-cheerfully-keeping-her-arms-folded-relaxing-indoors-after-morning-lectures-university.jpg')}}" class="img-fluid avatar-image" alt="">
                    ...
                    <div class="tab-pane fade" id="nav-DayFour" role="tabpanel" aria-labelledby="nav-DayFour-tab">
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <img src="{{url('public/frontend/images/schedule/jeshoots-com-TWRCH-GaKr4-unsplash.jpg')}}" class="schedule-image img-fluid" alt="">
                            </div>
